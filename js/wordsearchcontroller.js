...
function WordSearchController(gameId, listId, solveId, newGameId, instructionsId, themeId) {
	...
	var searchTypes = {
		...
		"On the occasion of Autism Awareness Day, solve this fun game and win a voucher of Rs. 200 to shop from an array of products made by Artisans with Disabilities!": [
			["Aspergers", "Awareness", "Treatment","Equality","DEVELOPMENT"],
			[ "Disorder","Autism", "Brain", "COMMUNICATION","ASD"],
			],
